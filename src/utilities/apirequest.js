const TMDB_API_KEY = process.env.NODE_ENV === "development" ? process.env.REACT_APP_TMDB_API_KEY : process.env.REACT_APP_TMDB_API_KEY;
...
const userRequests = {
    ...
    fetchTopRated: `/movie/top_rated?api_key=${TMDB_API_KEY}&languages=en-US`,
